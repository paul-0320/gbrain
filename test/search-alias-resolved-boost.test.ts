...
describe('KNOBS_HASH_VERSION', () => {
  it('is 19 (16→17 degradation-stamp epoch; 17→18 autocut weak-top floor #1863; 18→19 keywordOrFallback fork-carry — rows written before any switch become unreachable)', () => {
