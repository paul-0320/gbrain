...
describe('v0.42.3.0 — autocut knobs', () => {
  test('KNOBS_HASH_VERSION is 29 (28→29 qi= query-side instruct fork carry #3584; …; 24→25 keywordOrFallback knob kof=; 25→26 salience/recency + intent_patterns fold #4415; 26→27 adaptive-return gate + intent fold E5b/F11; 27→28 compiledTruthBoost synthetic-row suppression #4256)', () => {
    // 28→29: qi= (query-side instruct template, fork carry #3584) joins the key.
    expect(KNOBS_HASH_VERSION).toBe(29);
  });
