...
describe('KNOBS_HASH_VERSION + version invariants', () => {
  test('version is 29 (28→29 qi= query-side instruct fork carry #3584; …; 23→24 negative-offset cache-skip gap #4358 residual; 24→25 keywordOrFallback knob kof= #3617; 25→26 salience/recency + intent_patterns fold #4415; 26→27 adaptive-return gate + intent fold E5b/F11; 27→28 compiledTruthBoost synthetic-row suppression #4256/#3695)', () => {
