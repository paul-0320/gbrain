...
describe('KNOBS_HASH_VERSION + version invariants', () => {
  test('version is 27 (…; 21→22 result-stamp/injection epoch #1663 #3995 #3783 #4220; 22→23 excludePrivate posture fold #4352; 23→24 keywordOrFallback knob kof=; 25→26 salience/recency + intent_patterns fold #4415; 26→27 query-instruct qi= fork carry)', () => {
